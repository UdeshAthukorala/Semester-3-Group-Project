...
if (isset($_POST['dob'])) {
  ...
  if ($age>125) {
	...
	header("Location: RegisterDocRec.php"); die();
  }
  elseif($age<=0){
...
if (isset($_POST['specialization'])) {
	$splids = $_POST['specialization'];
	$spljoinid = allspltosplid($splids);
}else{
	$spljoinid = '';
}
...
if(isset($_POST['username'])){
	...
	if ($num_rows>=1) {
		...
		$query2 = "INSERT INTO `basicdetaildoctor` (`title`, `username`, `characterid`, `firstname`, `lastname`, `email`, `contactno`, `address`, `dob`, `gender`, `registertimestamp`, `specializationin`) VALUES ('$title', '$username', '$characterid', '$fname', '$lname', '$email', '$contactno', '$address', '$dob', '$gender', '$currenttime', '$spljoinid');";
