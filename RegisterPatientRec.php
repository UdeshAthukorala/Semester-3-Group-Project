...
<!--form for Register Patient !-->


  <div class="container">
    <div class="center card border-primary mb-3" style="max-width: 40rem; margin: auto; top : 20px;">
      <div class="card-header"><center><h2>Register - Patient</h2></center></div>
      <div class="card-body">
        ...
        <form action="RegisterPatientRecFnc.php" method="post" autocomplete="on">
          <fieldset>
            ...
            <div class="form-group">
              <label class="col-form-label" for="inputDefault">Blood Group <tagname style="font-size: 10px;">(Not Required) </tagname> </label>
            ...
            <div class="form-group">
              <label for="exampleTextarea">please include if continuously taking any medication. Include other comments regarding your Permanent Medical History. <tagname style="font-size: 10px;">(Not Required) </tagname></label>
              <textarea class="form-control" id="healthissue" name="healthissue" rows="3"></textarea>
            </div>
  ...
  <script type="text/javascript">
    ...
    function validatePassword(){
      if(password.value != confirm_password.value) {
        confirm_password.setCustomValidity("Password isn't Match");
      } else {
